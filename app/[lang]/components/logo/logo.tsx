  ...
  return (
    <a href="#" className="inline-flex shrink-0 focus:rounded-md">
      ...
      <svg
        className={clsx(
          styles.logo,
          "h-9 w-auto relative top-1 xs:h-14 xl:h-16s p-1 xs:p-2"
        )}
