...
const Logo: FunctionComponent = () => {
  ...
  const isHome = i18n.locales.some(
    (locale) => locale === pathname.replaceAll("/", "").replaceAll("/", "")
  );
  ...
  useEffect(() => {
    setPathnameQueries((prevPathnames) => [...prevPathnames, pathname]);
  }, [pathname]);
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path
          className={clsx({
            [styles.dashGreyedOut]: !isHome && pathnameQueries.length === 1,
            [styles.dashOneInactive]: !isHome && pathnameQueries.length !== 1,
            [styles.dashOneActive]: isHome && pathnameQueries.length !== 1,
            [styles.dashFilled]: isHome && pathnameQueries.length === 1,
          })}
        ...
        <path
          className={clsx({
            [styles.dashGreyedOut]: !isHome && pathnameQueries.length === 1,
            [styles.dashTwoInactive]: !isHome && pathnameQueries.length !== 1,
            [styles.dashTwoActive]: isHome && pathnameQueries.length !== 1,
            [styles.dashFilled]: isHome && pathnameQueries.length === 1,
          })}
