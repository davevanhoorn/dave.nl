...
const Logos = () => (
  <div
    id={styles.logos}
    className="mb-6 lg:p-4 lg:pb-0 lg:pt-8 lg:mb-16 max-w-screen-xl mx-auto flex flex-wrap md:flex-no-wrap items-center justify-around"
  >
    <a href="https://www.schiphol.nl/nl/" title="Schiphol" rel="noopener noreferrer nofollow" target="_blank">
    ...
    <a href="https://www.euroclear.com/en.html" title="Euroclear" rel="noopener noreferrer nofollow" target="_blank">
      <img className={styles.logo_euroclear} src="/company_euroclear.svg" alt="Logo Euroclear" />
    </a>
  </div>
)
