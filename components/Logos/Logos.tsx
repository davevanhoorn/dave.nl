...
const Logos = () => (
  <div id={styles.logos} className="flex flex-wrap md:flex-no-wrap items-center justify-between mt-20 px-4 max-w-screen-lg mx-auto">
    ...
    <a href="https://www.capgemini.com/" title="Capgemini" rel="noopener noreferrer" target="_blank">
      <img className={styles.logo_capgemini} src="/company_capgemini.svg" alt="Logo Capgemini" />
    </a>
    <a href="https://noten.nl/" title="Noten.nl" rel="noopener noreferrer" target="_blank">
      <img className={styles.logo_noten} src="/company_noten.svg" alt="Logo Noten.nl" />
    </a>
    <a href="https://www.vteam.tv/" title="Vteam.tv" rel="noopener noreferrer" target="_blank">
      <img className={styles.logo_vteam} src="/company_v-team.svg" alt="Logo Vteam.tv" />
    </a>
    <a href="https://www.schiphol.nl/nl/" title="Schiphol" rel="noopener noreferrer" target="_blank">
      <svg className={styles.logo_schiphol} width="265" height="70" viewBox="0 0 265 70" role="img" aria-label="Logo Schiphol">
    ...
    <a href="https://reisreport.nl/" title="ReisReport" rel="noopener noreferrer" target="_blank">
