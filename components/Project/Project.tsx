...
const Project = () => (
  <div
    className={
      classNames({
        [styles.projectBackground]: true,
        'w-full relative': true,
      })
    }
  >
    <svg className="w-full absolute top-0" xmlns="http://www.w3.org/2000/svg" width="2022.245" height="123.476" viewBox="0 0 2022.245 123.476" preserveAspectRatio="none">
    ...
    <div className="max-w-screen-lg mx-auto flex items-end">
      <motion.img
        ...
        className="relative z-10 w-7/12 -ml-24 origin-bottom-left"
        src="/project_schiphol@2x.png"
        alt="Smartphone met Schiphol project op het scherm"
      />
      <div className="py-40 flex flex-col w-6/12 text-lg items-start">
        ...
        <p className="mt-4 bg-white p-2">
          In opdracht van
          {' '}
          <a className="font-bold hover:underline" href="https://orangetribes.com" title="Orange Tribes" rel="noopener noreferrer nofollow" target="_blank">Orange Tribes</a>
          {' '}
        ...
        <p className="mt-6 bg-white p-2 font-bold hover:underline inline">
    ...
    <svg className="w-full absolute bottom-0 z-20" xmlns="http://www.w3.org/2000/svg" width="2003.093" height="74.385" viewBox="0 0 2003.093 74.385" preserveAspectRatio="none">
