    ...
    >
      ...
      {smallScreenMenuVisible && (
        ...
        >
          ...
          />
          <motion.div
            className="relative z-40 w-full h-full flex flex-col items-center justify-between origin-top"
            initial={{ scaleY: 0.98, opacity: 0, y: -4 }}
            animate={{
              scaleY: smallScreenMenuVisible ? 1 : 0,
          ...
          >
            ...
            <div className="flex items-center justify-center flex-col uppercase">
              ...
              <div className="flex mt-5">
                <svg className="w-7 mx-1 p-1" fill="white" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
