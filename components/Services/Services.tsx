...
const Services = () => (
  <>
    <h2 className="p-4 text-4xl font-bold leading-tight text-center mt-8 md:mt-10 md:mb-16 text-gray-400">Dit kan ik voor je doen:</h2>
    <div className="flex flex-wrap p-4 lg:py-0 lg:mb-20 max-w-screen-lg mx-auto lg:mt-12 text-lg leading-relaxed font-medium">
      <div className="p-4 md:p-0 w-full md:w-6/12 md:pl-24 md:pr-4 md:mb-12">
        <h6 className="text-2xl md:text-5xl mb-2 font-bold leading-tight">WordPress optimalisatie</h6>
        <p className="mb-2">
      ...
      <div className="p-4 md:p-0 md:w-6/12 md:pr-12 md:pl-12 md:mb-12">
        <h6 className="text-2xl md:text-5xl mb-2 font-bold leading-tight">WooCommerce maatwerk</h6>
        <p className="mb-2">
      ...
      <div className="p-4 md:p-0 md:w-6/12 md:pl-24 md:pr-4 md:mb-12">
        <h6 className="text-2xl md:text-5xl mb-2 font-bold leading-tight">Een MVP maken</h6>
        <p className="mb-2">
          Ik kan een minimum viable product maken om jouw concept te valideren, zoals ik eerder deed voor Schiphol.
        </p>
        <Link href="/wordpress-websites">
      ...
      <div className="p-4 md:p-0 md:w-6/12 md:pr-12 md:pl-12 md:mb-12">
        <h6 className="text-2xl md:text-5xl mb-2 font-bold leading-tight">Een kapotte site repareren</h6>
        <p className="mb-2">
