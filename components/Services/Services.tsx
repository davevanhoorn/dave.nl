  ...
  <>
    ...
    <div className="flex flex-wrap p-4 lg:py-0 lg:mb-20 max-w-screen-lg mx-auto lg:mt-12 text-lg leading-relaxed font-medium">
      ...
      <div className="p-4 md:p-0 md:w-6/12 md:pr-12 md:pl-12 md:mb-12">
        <h6 className="text-2xl md:text-3xl mb-2 font-bold leading-tight">WooCommerce maatwerk</h6>
        <p className="mb-2">
      ...
      <div className="p-4 md:p-0 md:w-6/12 md:pl-24 md:pr-4 md:mb-12">
        <h6 className="text-2xl md:text-3xl mb-2 font-bold leading-tight">Een &quot;MVP&quot; maken</h6>
        <p className="mb-2">
      ...
      <div className="p-4 md:p-0 md:w-6/12 md:pr-12 md:pl-12 md:mb-12">
        <h6 className="text-2xl md:text-3xl mb-2 font-bold leading-tight">Een kapotte site repareren</h6>
        <p className="mb-2">
